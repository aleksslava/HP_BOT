...
LEXICON_RU: dict[str, str] = {
    ...
    'admin_main_menu': 'Вы вошли в панель администратора.\nВыберите необходимый пункт меню.',
    'admin_menu_exit': 'Вы вышли из меню администратора.\nВсе не сохранённые изменения удалены.'
}
...
admin_main_menu: dict[str, str] = {
    'Добавить устройство': 'add_item',
    'Редактировать устройство': 'edit_item',
    'Удалить устройство': 'del_item',
    'Добавить тег': 'add_tag',
    'Удалить тег': 'del_tag'
}

admin_menu_exit: dict[str, str] = {
    'Выход из меню': 'exit_admin_menu'
}